...
------------------------
Compile: g++ -std=c++17 Enemy.cpp Map.cpp Item.cpp Player.cpp Game.cpp GameDriver.cpp
Run: ./a.out
------------------------
DEPENDENCIES
------------------------
...
------------------------------
- Using classes in all Header Files 
- Using constructors and destructors in classes 
- Using pointers in Item.cpp and Item.h
- Using inheritance in Player.h/ Player.cpp
- stored all enemies encountered to file, file outputted at end 
